define(function(require){
    ...
    {/*{{{*/
        ...
        if (dz.embedded==1) {
            ...
            new mwt.BorderLayout({
                render : 'frame-center',
                items : [
                    {id:'frame-header',region:'north',height:35},
    ...
    {/*{{{*/
        new mwt.BorderLayout({
            ...
            items : [ 
                // logo区
                {id:'frame-logo',region:'north',height:50,
                 html:'<a class="logoa" href="#/">'+
                        '<label>'+
                            '<img src="'+dz.pluginpath+'/template/static/ankix-logo.png">'+
                            'Anki X'+
                        '</label></a>'},
                // 导航菜单区
                {id:'frame-nav',region:'center',style:"padding-top:8px;"}
            ]
        }).init();
        initNav();
    }/*}}}*/
    ...
    {/*{{{*/
        ...
        jQuery('#ucpopbtn').hover(
            function(){mwt.showFloatDiv("ucpop",-10,28);},
