define(function(require){
    /* generated by mengma @2018-09-19 02:38 
     *
     * usage:
        require('combox/combox_supplier').create({
            render   : 'fm-id',
            text     : '请选择',
            value    : 0,
            popWidth : 300,
    ...
    function init_grid(domid) 
    {
        ...
        store = new mwt.Store({
            proxy: new mwt.HttpProxy({
                url: ajax.getAjaxUrl("city&action=query")
            })
        }); 
        // tbar
        var tbar =  [];
