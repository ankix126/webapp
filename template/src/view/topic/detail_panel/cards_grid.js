    ...
    o.init = function(domid){
        ...
        store = new mwt.Store({
            proxy: new mwt.HttpProxy({
                ...
                url : ajax.getAjaxUrl("t_cards&action=query")
            })
        });
        grid = new MWT.Grid({
            render      : gridid,
            ...
            cm: new MWT.Grid.ColumnModel([
                {head:'卡片ID',dataIndex:'cid',width:120,align:'left',sort:false,render:function(v,item){
                    return v;
                }},
                {head:'模板ID',dataIndex:'tid',width:120,align:'left',sort:false,render:function(v,item){
                    return v;
                }},
                {head:'卡片名称',dataIndex:'cname',width:120,align:'left',sort:false,render:function(v,item){
                    return v;
                }},
                ...
                {head:'更新时间',dataIndex:'update_time',width:120,align:'left',sort:false,render:function(v,item){
                    return v;
                }},
